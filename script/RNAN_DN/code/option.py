...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/wyf/data/DN/RGB/npy',
...
parser.add_argument('--testpath', type=str, default='/home/yifan/data',
                    help='dataset directory for testing')
parser.add_argument('--testset', type=str, default='Kodak24',
                    help='dataset name for testing')
parser.add_argument('--testtime', type = int, default = 0, 
		    help = 'enable testtime mode')
